...
<!--  -Start of the Student Entry Form-  -->
   <div class="container mb-2">
      ...
      <form>
      <div class="col-3">
               <button type="submit" class="btn btn-primary mb-2 form-control" id="studentBTN" name="studentBTN">Load Training Records</button>
            </div>
      </form>
   </div>
   <hr>
   <?php
      $query2 = 'SELECT cr.id, course_code, course_end_date, first_name, last_name, employee_number FROM course_record cr JOIN student s ON cr.student_id=s.id ORDER BY cr.course_end_date DESC;';
